...
def get_external_sensors(external_sensor_service: ExternalSensorService = Depends(ExternalSensorService)) -> list[ExternalSensorResponse]:
...
async def add_external_sensor_measurement(request: Request, add_external_sensor_measurement_request: AddExternalSensorMeasurementRequest, external_sensor_service: ExternalSensorService = Depends(ExternalSensorService)) -> None:
