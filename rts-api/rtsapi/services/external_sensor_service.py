...
class ExternalSensorService:
    def __init__(self, external_sensor_repository: ExternalSensorRepository = Depends(ExternalSensorRepository), synchronizer_service: SynchronizerService = Depends(SynchronizerService)) -> None:
    ...
    def add_external_sensor_measurement(self, client_ip: str, measurement_request: AddExternalSensorMeasurementRequest) -> None:
        ...
        self.synchronizer_service.handle_external_sensor_measurement(external_sensor.id, measurement_request)
    ...
    def get_external_sensor_measurements(self, sensor_id: UUID) -> list[ExternalSensorMeasurementResponse]:
    ...
    def update_external_sensor(self, sensor_id: UUID, name: str) -> ExternalSensorResponse:
        external_sensor = self.external_sensor_repository.get_external_sensor(sensor_id)
