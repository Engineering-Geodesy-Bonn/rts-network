...
class SessionService:
    ...
    def create_session(self, create_session_request: dtos.CreateSessionRequest) -> dtos.SessionResponse:
        db_session = self.session_repository.add_session(SessionMapper.to_db(create_session_request))
